...
function ellak_credits() {
	echo __( '<a href="https://mathe.ellak.gr/" target="_blank">Built with open source software </a>', 'gpchild-ellak' )
		. ' <a href="https://wordpress.org/" target="_blank"> Wordpress</a> | '
		. '<a href="https://ellak.gr/ori-chrisis" target="_blank">'
		. __( 'Terms of use and privacy statement', 'gpchild-ellak' ) . '</a> | '
		. __( 'Content Licence:', 'gpchild-ellak' )
		. ' <a href="https://creativecommons.org/licenses/by-sa/4.0/deed">'
		. __( 'CC-BY-SA', 'gpchild-ellak' ) . '</a> | '
		. ' <a href="contact/">'
		. __( 'Contact', 'gpchild-ellak' ) . '</a>';
}
